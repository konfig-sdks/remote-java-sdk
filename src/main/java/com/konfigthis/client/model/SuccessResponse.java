...
import com.konfigthis.client.model.SuccessResponseData;
...
public class SuccessResponse {
  ...
  public SuccessResponse data(SuccessResponseData data) {
  ...
  **/
   ...
   * @return the SuccessResponse instance itself
   */
  ...
  * @throws IOException if the JSON Object is invalid with respect to SuccessResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SuccessResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      SuccessResponseData.validateJsonObject(jsonObj.getAsJsonObject("data"));
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<SuccessResponse>() {
           ...
           public SuccessResponse read(JsonReader in) throws IOException {
             ...
             SuccessResponse instance = thisAdapter.fromJsonTree(jsonObj);
