...
public class WebhookCallback {
 ...
 public enum SubscribedEventsEnum {
  ...
  public WebhookCallback id(String id) {
  ...
  **/
  ...
  public WebhookCallback signingKey(String signingKey) {
  ...
  **/
  ...
  @ApiModelProperty(value = "This key will be used to sign the signature provided with webhook requests we send to the `url` you provided for this webhook callback.  The webhook signature will be included in a custom header, `X-Remote-Signature`. You can use this signature to verify that requests are coming from Remote and not some unauthorized third-party. ")
  ...
  public WebhookCallback subscribedEvents(List<SubscribedEventsEnum> subscribedEvents) {
  ...
  public WebhookCallback addSubscribedEventsItem(SubscribedEventsEnum subscribedEventsItem) {
  ...
  **/
   ...
   * @return the WebhookCallback instance itself
   */
  public WebhookCallback putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, webhookCallback.id) &&
        Objects.equals(this.signingKey, webhookCallback.signingKey) &&
        Objects.equals(this.subscribedEvents, webhookCallback.subscribedEvents) &&
        Objects.equals(this.url, webhookCallback.url)&&
        Objects.equals(this.additionalProperties, webhookCallback.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, signingKey, subscribedEvents, url, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhookCallback
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhookCallback.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookCallback is not found in the empty JSON string", WebhookCallback.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhookCallback.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookCallback.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookCallback' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookCallback> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookCallback.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookCallback>() {
           @Override
           public void write(JsonWriter out, WebhookCallback value) throws IOException {
           ...
           @Override
           public WebhookCallback read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             WebhookCallback instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of WebhookCallback given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WebhookCallback
  * @throws IOException if the JSON string is invalid with respect to WebhookCallback
  */
  public static WebhookCallback fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookCallback.class);
  }

 /**
  * Convert an instance of WebhookCallback to an JSON string
  *
  * @return JSON string
  */
