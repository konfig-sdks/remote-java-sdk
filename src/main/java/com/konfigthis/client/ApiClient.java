...
public class ApiClient extends ApiClientCustom {
    ...
    private String basePath = "https://gateway.remote.com";
    private String tokenUrl = "/auth/oauth2/token";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://gateway.remote.com)
     ...
     * Set token url
     *
     * @param tokenUrl Token URL for oauth (e.g /auth/oauth2/token)
     * @return An instance of OkHttpClient
     */
