...
|------------- | ------------- | -------------|
| [**getTokenInfo**](IdentityApi.md#getTokenInfo) | **GET** /v1/identity/current | Get token identity |


<a name="getTokenInfo"></a>
# **getTokenInfo**
> Object getTokenInfo().execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling IdentityApi#getTokenInfo");
